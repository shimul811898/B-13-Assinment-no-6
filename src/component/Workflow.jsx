        ...
        <div className=" bg-gradient-to-r from-[#4F39F6] to-[#9514FA] text-white text-center py-16 px-4  ">
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="flex gap-3 justify-center">
                    <button className="btn rounded-full px-6 bg-white hover:scale-105 transition duration-300">
                        <span className="bg-gradient-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent">
                            Explore Products
                        </span>
                    </button>
                    <button className="btn rounded-full px-6 bg-transparent border-white text-white hover:scale-105 transition duration-300">View Pricing</button>
                </div>
